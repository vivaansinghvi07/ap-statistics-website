...
<?php startblock('description') ?>
  <div style = "text-align: center" class = "notes">A website built for AP Statistics, with notes and calculators for each topic.</div>
<?php endblock() ?>

<?php startblock('output') ?>
    <ul class = "notes" style = "font-size: 35px;">
